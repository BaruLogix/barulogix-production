          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="bg-secondary-500 hover:bg-secondary-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200"
              >
                ← Volver al Panel
              </button>
              {lastUndoableOperation && (
                <button
                  ...
                  className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {undoLoading ? 'Deshaciendo...' : '↩️ Deshacer Última Operación'}
                </button>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-sm text-secondary-600">
                <p>©2025 BaruLogix</p>
                <p>BaruLogix By BaruCourier S.A.S.</p>
              </div>
            </div>
            <div className="flex items-center space-x-2 text-sm text-secondary-600">
              <span>Plataforma creada por:</span>
              <Image
                src="/scibaru-logo.png"
                alt="ScibaruAI"
                width={20}
                height={20}
                className="rounded"
