      ...
      <header className="header-barulogix">
        <div className="header-content">
          <div className="flex items-center">
            ...
            />
            <div>
              <h1 className="text-2xl font-bold text-secondary-800 font-montserrat mb-0">BaruLogix</h1>
              <p className="text-sm text-secondary-600 font-segoe mt-0 mb-0">Panel de Control</p>
              <p className="text-xs text-gray-500 mt-0 ml-2">By BaruCourier S.A.S</p>
            </div>
          </div>
          ...
          <div className="card-barulogix-lg animate-fade-in">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full p-4 border border-blue-200 rounded-xl hover:bg-blue-50 transition-all duration-200 text-left hover-lift"
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-semibold text-secondary-900 font-montserrat">Administración</p>
                    <p className="text-sm text-secondary-600 font-segoe">Operaciones administrativas avanzadas</p>
                  </div>
                </div>
              </button>

              <button
                onClick={() => navigateTo('/delete-data')}
                className="w-full p-4 border border-red-300 rounded-xl hover:bg-red-50 transition-all duration-200 text-left hover-lift bg-red-25"
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-semibold text-red-900 font-montserrat">⚠️ Eliminar Datos</p>
                    <p className="text-sm text-red-700 font-segoe">Operaciones de eliminación y formateo</p>
                  </div>
                </div>
              </button>
            </div>
