          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="bg-white text-secondary-700 px-4 py-2 rounded-lg border border-secondary-300 hover:bg-secondary-50 transition-colors duration-200 flex items-center font-segoe"
              >
              ...
              <button
                ...
                className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors duration-200 font-segoe"
              >
                Cerrar Sesión
              </button>
            </div>
