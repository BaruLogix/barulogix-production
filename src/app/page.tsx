    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <Image
                ...
                className="mr-4"
              />
              <h1 className="text-3xl font-bold text-gray-800 font-montserrat">BaruLogix</h1>
            </div>
            <div className="flex space-x-4">
              <button
                onClick={() => router.push('/auth/login')}
                className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 px-4 rounded-lg transition-colors duration-200 border border-gray-300"
              >
                Iniciar Sesión
              </button>
              <button
                onClick={() => router.push('/auth/register')}
                className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 shadow-lg"
              >
                Registrarse
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              <h2 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 font-montserrat leading-tight">
                Gestiona tus entregas con
                <span className="text-blue-500 block">BaruLogix</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => router.push('/auth/register')}
                  className="bg-blue-500 hover:bg-blue-600 text-white font-bold text-lg px-8 py-4 rounded-lg transition-colors duration-200 shadow-lg flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold text-lg px-8 py-4 rounded-lg transition-colors duration-200 border border-gray-300 flex items-center justify-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex justify-center lg:justify-end animate-fade-in">
              <div className="relative">
                <div className="absolute inset-0 bg-blue-500 rounded-full opacity-20 blur-3xl transform scale-150"></div>
                <Image
                  src="/emblema-barulogix.png"
                  alt="Emblema BaruLogix"
                  width={400}
                  height={400}
                  className="relative z-10 transition-transform duration-200 hover:-translate-y-1"
                />
              </div>
            </div>
          </div>
      ...
      <section id="caracteristicas" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-gray-900 mb-4 font-montserrat">
              Características Principales
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Gestión de Paquetes */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Gestión de Paquetes</h4>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Control de Conductores</h4>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Reportes Detallados</h4>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Búsqueda Avanzada</h4>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Análisis de Rendimiento</h4>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 transition-transform duration-200 hover:-translate-y-1 text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-4 font-montserrat">Seguridad y Respaldos</h4>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-500 to-blue-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <button
            onClick={() => router.push('/auth/register')}
            className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-4 px-8 rounded-lg transition-colors duration-200 text-lg shadow-lg"
          >
